...
const STRINGS: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "agents.externalArms.title": "外部 MCP 臂(低 token broker):",
    "agents.externalArms.summary": "只暴露 compact external_arm.request;截图、轨迹、日志存为 artifacts,不要把完整 MCP schema 塞进模型上下文。",
  ...
  en: {
    ...
    "agents.externalArms.title": "External MCP arms (low-token broker):",
    "agents.externalArms.summary": "Expose only compact external_arm.request; keep screenshots, traces, and logs as artifacts instead of putting full MCP schemas into model context.",
