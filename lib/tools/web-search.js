...
function buildSearchPlan(query) {
  ...
  const expandedQuery = expandQueryForScene(query, scene);
  const preferredSources = scene === "finance"
  ...
  return {
    scene,
    expandedQuery,
    preferFresh: scene === "realtime" || scene === "finance",
    preferDocs: scene === "docs",
    suggestDeepRead: scene === "research" || scene === "docs" || scene === "finance" || scene === "realtime" || scene === "sports",
    preferredSources,
    requiresSpecializedData: scene === "finance" || scene === "sports",
    shouldCrossVerify: scene === "finance" || scene === "sports" || scene === "realtime",
  };
}
