...
const HK_TECH_BASKET_SYMBOLS = ["00700", "09988", "03690", "01810", "01024", "09618"];
const US_TECH_BASKET_SYMBOLS = ["AAPL", "MSFT", "NVDA", "GOOGL", "AMZN", "META", "TSLA"];

const A_STOCK_NAME_TO_SYMBOL = new Map([
  ["雪人集团", "002639"],
  ["华丰科技", "688629"],
  ["拓维信息", "002261"],
  ["每日互动", "300766"],
...
const A_STOCK_BASKETS = [
  {
    re: /(?:A股|a股|沪深|科创|创业板).{0,12}(?:AI|人工智能|算力|服务器|光模块|CPO|高速连接|科技|半导体|芯片)|(?:AI|人工智能|算力|服务器|光模块|CPO|高速连接|半导体|芯片).{0,12}(?:A股|a股|沪深|科创|创业板)/i,
    symbols: ["688629", "300308", "300502", "002230", "000977", "688981"],
  },
  {
    re: /(?:A股|a股|沪深|创业板|科创).{0,12}(?:新能源|电动车|锂电|光伏)|(?:新能源|电动车|锂电|光伏).{0,12}(?:A股|a股|沪深|创业板|科创)/i,
    symbols: ["300750", "002594", "601012", "300014"],
  },
  {
    re: /(?:A股|a股|沪深|创业板|科创).{0,12}(?:机器人|人形机器人)|(?:机器人|人形机器人).{0,12}(?:A股|a股|沪深|创业板|科创)/i,
    symbols: ["300024", "688017", "002747", "300124"],
  },
  {
    re: /(?:A股|a股|沪深).{0,12}(?:券商|证券)|(?:券商|证券).{0,12}(?:A股|a股|沪深)/i,
    symbols: ["600030", "601688", "600837", "000776"],
  },
  {
    re: /(?:A股|a股|沪深).{0,12}(?:白酒|消费)|(?:白酒|消费).{0,12}(?:A股|a股|沪深)/i,
    symbols: ["600519", "000858", "000568", "000596"],
  },
];

const SLOW_OR_LOW_VALUE_CONCEPT_HOST_RE =
...
const NOISY_FINANCE_SOURCE_NAMES = new Set(["东方财富", "中信证券"]);

const FINANCE_LOOKUP_CONTEXT_RE =
  /(?:股票|股价|行情|最新价|现价|收盘|开盘|涨跌|成交|市值|美股|港股|A股|a股|纳斯达克|纽交所|道指|标普|纳指|概念股|板块|行业|题材|赛道|龙头|成分股|ticker|symbol|stock|share|price|quote|market|nasdaq|nyse)/i;
