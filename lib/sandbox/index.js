 ...
 */
export function createSandboxedTools(cwd, customTools, { agentDir, workspace, lynnHome, mode }) {
  const policy = deriveSandboxPolicy({ agentDir, workspace, lynnHome, mode });
