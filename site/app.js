const RELEASE = {
  version: "0.75.2",
  releasePage: "https://github.com/MerkyorLynn/Lynn/releases/tag/v0.75.2",
  assets: {
    macArm:
      "https://github.com/MerkyorLynn/Lynn/releases/download/v0.75.2/Lynn-0.75.2-macOS-Apple-Silicon.dmg",
    macIntel:
      "https://github.com/MerkyorLynn/Lynn/releases/download/v0.75.2/Lynn-0.75.2-macOS-Intel.dmg",
    windows:
      "https://github.com/MerkyorLynn/Lynn/releases/download/v0.75.2/Lynn-0.75.2-Windows-Setup.exe",
  },
};
